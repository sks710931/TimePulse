...
public interface IAuthService
{
    ...
    Task<Result<bool>> RequestPasswordResetAsync(ForgotPasswordRequest request, string? clientBaseUrl = null, CancellationToken cancellationToken = default);
    Task<Result<ValidateResetTokenResponse>> ValidateResetTokenAsync(string token, CancellationToken cancellationToken = default);
